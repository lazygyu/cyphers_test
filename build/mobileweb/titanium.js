...
var require = {
	app: {
		analytics: true,
		copyright: "2013 by lazygyu",
		deployType: "development",
		description: "not specified",
		guid: "52259e56-2c7d-4d26-9c68-97e0fb3a26d0",
		id: "com.lazygyu.finishit",
		name: "FinishIt",
		names: {},
		publisher: "lazygyu",
		url: "http://lazygyu.net",
		version: "1"
	},
	has: {
...
require("Ti/App/Properties", function(p) {
	p.setString("acs-oauth-secret-production","9QDaXQZupZehi1zdumV1PHiVRqWgQXjJ");
	p.setString("acs-oauth-key-production","P5M97xGwd7smFs8B5bkpFVKqbdySQqKY");
	p.setString("acs-api-key-production","kreKVPbSz5qIWveIOxVw9To9z9CEHcrz");
	p.setString("acs-oauth-secret-development","sjZMSEWYy8AuCL343c1qUBv8XMkMwVJM");
	p.setString("acs-oauth-key-development","wUiUB8jNG8ErGxvbBGjzfvF4zYILem20");
	p.setString("acs-api-key-development","I5KzIpmB4ODufAZTNR3kIeqIwesu8Yrl");
